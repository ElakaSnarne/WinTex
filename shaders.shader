...
float4 FontPS(TexturedPixelInputType input) : SV_TARGET
{
	float4 textureColor = shaderTexture.Sample(AASampleType, input.tex);

	float4 ret;
	ret.a = textureColor.a*colour.a;
	ret.r = textureColor.r*colour.r;
	ret.g = textureColor.g*colour.g;
	ret.b = textureColor.b*colour.b;
